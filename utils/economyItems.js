...
const ITEMS = {
  ...
  lucky_clover: {
    ...
    buyPrice: 250,
    sellPrice: 80,
    description: 'Consumable that grants 15 minutes of 2x Lucky Drop Chance for fishing/hunting/mining.'
  },
  energy_drink: {
    id: 'energy_drink',
    ...
    buyPrice: 180,
    sellPrice: 60,
    description: 'Drink to immediately reset your fishing, hunting, mining, and digging cooldowns!'
  },
  mystery_box: {
    id: 'mystery_box',
